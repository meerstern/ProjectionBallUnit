...
void GetDateTime()
{
	...
	i2c_write_blocking(I2C_PORT, RV8803C7_ADDR, wdat, 1, true); 
	i2c_read_blocking(I2C_PORT, RV8803C7_ADDR, rdat, 7, false);
...
void SetRtcRam(uint8_t addr, uint8_t data)
{
    ...
    wdat[0]=addr;
    wdat[1]=data;
	i2c_write_blocking(I2C_PORT, RV8803C7_ADDR, wdat, 2, false);
}
...
void GetRtcRam(uint8_t addr, uint8_t *data)
{
	...
	i2c_write_blocking(I2C_PORT, RV8803C7_ADDR, wdat, 1, true); 
	i2c_read_blocking(I2C_PORT, RV8803C7_ADDR, rdat, 1, false);
...
void SetRtcTime(uint8_t h, uint8_t m, uint8_t s)
{
	...
	i2c_write_blocking(I2C_PORT, RV8803C7_ADDR, wdat, 4, false);
}
...
void GetRtcTime(uint8_t *h, uint8_t *m, uint8_t *s)
{
	...
	i2c_write_blocking(I2C_PORT, RV8803C7_ADDR, wdat, 1, true); 
	i2c_read_blocking(I2C_PORT, RV8803C7_ADDR, rdat, 3, false);
